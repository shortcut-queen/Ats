...
<div style="position: relative;margin-top: 8%;width:100%;">
    <form class="form-horizontal" style="width: 40%;margin-left: 30%;text-align: center;"  name="upLoadResource" action="../Web/ProjectController.php" method="post">
        <label>上传资源</label>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="file" style="width;100%;" name="project_name"/>
                <select class="form-control" style="width: 50%;" name="resource_type">
                    <option>--资源类型--</option>
                    <option>文档</option>
                    <option>图片</option>
                    <option>视频</option>
