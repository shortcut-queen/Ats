    ...
    <script>
        $(document).ready(function(){
            $("#buttonSearch").click(function(){
                var army_array=new Array(document.scoreSearch.date.value,document.scoreSearch.brigade.value,document.scoreSearch.battalion.value,document.scoreSearch.continuous.value,document.scoreSearch.platoon.value,document.scoreSearch.monitor.value);
                if(army_array[0]=="")
                        ...
                        $.post(document.scoreSearch.action,
                            {
                                ...
                                brigade:document.scoreSearch.brigade.value,
...
<div style="position: relative;width:100%;text-align:center;font-size:large;margin-top: 4%">查看成绩</div>
<div style="position: relative;margin-top: 4%;text-align: center">
    <?php
    $option_names=array(
        array('brigade','旅级','一旅','二旅','三旅')
    ...
    ,array('monitor','班级','一班','二班','三班'));
        ...
        echo"<form class='form-inline' name='scoreSearch' action='../Web/AdminController.php' method='post'>";
