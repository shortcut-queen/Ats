...
<div style="position: relative;margin-top: 8%;width:100%;">
    <table style="width: 80%;margin-left: 10%;text-align: center;" class="table">
        <tr>
            ...
            <td><span style="float: right;margin-right: 10%;color: #777777"><?php echo "by—".$row['Admin_Name']."—".$row['Upload_Date']?></span></td>
        </tr>
        <tr>
            <td colspan="2">
                <?php
        ...
        <tr>
            ...
            <td><a href="DeleteResource.php?resource_id=<?php echo $resource_id;?>&resource_type=<?php echo $row['Resource_Type'];?>&resource_address=<?php echo $row['Resource_Address']?>"><button class="btn btn-danger">删除</button></a></td>
        </tr>
    </table>
</div>
</body>
